...
?>
         ...
         <div class="page-content">
            ...
            <!-- Welcome --> 
            <!-- <section class="about-section-home" data-cursor="white-color">
               <div class="container">
                  <div class="row">
                           ...
                           <div class="pbmit-ihbox-icon">
                              <div class="pbmit-ihbox-icon-wrapper">
                                 <div class="pbmit-icon-wrapper pbmit-icon-type-icon">
                                    <i class="pbmit-attorly-icon pbmit-attorly-icon-courthouse-2"></i>
                                 </div>
                              </div>
                           </div>
                           <div class="pbmit-ihbox-headingicon">
                              <h4 class="pbmit-element-heading"> Book Your</h4>
                              <h2 class="pbmit-element-title">Appointment</h2>
                           </div>
                        </div>
                     </div>
                    </div>
                    <div class="col-xl-4 col-md-6">
                     <div class="pbmit-ihbox pbmit-ihbox-style-2 pbmit-ihbox-two">
                        <div class="pbmit-ihbox-box d-flex align-items-center">
                           <div class="pbmit-ihbox-icon">
                              <div class="pbmit-ihbox-icon-wrapper">
                                 <div class="pbmit-icon-wrapper pbmit-icon-type-icon">
                                    <i class="pbmit-attorly-icon pbmit-attorly-icon-law"></i>
                                 </div>
                              </div>
                           </div>
                           <div class="pbmit-ihbox-headingicon">
                              <h4 class="pbmit-element-heading"> Get Free</h4>
                              <h2 class="pbmit-element-title"> Expert Advice</h2>
                           </div>
                        </div>
                     </div>
                  </div>
                     ...
                     <div class="pbmit-ihbox pbmit-ihbox-style-2 pbmit-ihbox-three">
                        <div class="pbmit-ihbox-box d-flex align-items-center">
                           <div class="pbmit-ihbox-icon">
                              <div class="pbmit-ihbox-icon-wrapper">
                                 <div class="pbmit-icon-wrapper pbmit-icon-type-icon">
                                    <i class="pbmit-attorly-icon pbmit-attorly-icon-contract-1"></i>
                                 </div>
                              </div>
                           </div>
                           <div class="pbmit-ihbox-headingicon">
                              <h4 class="pbmit-element-heading">You Can Easily</h4>
                              <h2 class="pbmit-element-title">Join Our Team</h2>
                           </div>
                        </div>
                     </div>
                  </div>
                              ...
                              <div class="about-us-main-home3">
                                 <div class="pbmit-ihbox pbmit-ihbox-style-4">
                                    <div class="pbmit-ihbox-box">
                                       ...
                                       <!-- <div class="pbmit-ihbox-icon">
                                          <div class="pbmit-ihbox-icon-wrapper">
                                             <div class="pbmit-icon-wrapper pbmit-icon-type-icon"><i class="pbmit-attorly-icon pbmit-attorly-icon-download"></i></div>
                                          </div>
                                       </div> -->
                     ...
                     <div class="col-md-6">
                        <div class="pbmit-sticky">
                           <div class="pbmit-heading text-left animation-style2">
                              <h2 class="pbmit-title">Practice Area</h2>
                           </div>
                           <p>With over a century of experience, Fox & Mandal has expertise in diverse practice areas. We employ a multidisciplinary approach and focus on collaboration with our clients to provide effective solutions and end-to-end service.</p>
                                 ...
                                 <div class="pbminfotech-post-item-inner">
                                    <div class="pbminfotech-box-content">
                                       <div class="pbminfotech-box-content-inner">
                                          <h3 class="pbmit-service-title"><a href="">Banking and Finance</a></h3>
                                       </div>
                                    </div>
                           ...
                           <div class="serviceBox pbminfotech-post-item d-flex justify-content-between">
                              <div class="innerBox d-flex justify-content-between align-items-center">
                                 <div class="pbminfotech-post-item-inner">
                                    <div class="pbminfotech-box-content">
                                       <div class="pbminfotech-box-content-inner">
                                          <h3 class="pbmit-service-title"><a href="">Corporate and Commercial</a></h3>
                                       </div>
                                    </div>
                                    <div class="pbmit-service-content">
                                       <div class="at-above-post-homepage addthis_tool"></div>
                           ...
                           <div class="serviceBox pbminfotech-post-item d-flex justify-content-between">
                              <div class="innerBox d-flex justify-content-between align-items-center">
                                 <div class="pbminfotech-post-item-inner">
                                    <div class="pbminfotech-box-content">
                                       <div class="pbminfotech-box-content-inner">
                                          <h3 class="pbmit-service-title"><a href="">Dispute Resolution | Arbitration</a></h3>
                                       </div>
                                    </div>
                                    <div class="pbmit-service-content">
                                       <div class="at-above-post-homepage addthis_tool"></div>
                           ...
                           <div class="serviceBox pbminfotech-post-item d-flex justify-content-between">
                              <div class="innerBox d-flex justify-content-between align-items-center">
                                 <div class="pbminfotech-post-item-inner">
                                    <div class="pbminfotech-box-content">
                                       <div class="pbminfotech-box-content-inner">
                                          <h3 class="pbmit-service-title"><a href="">Insolvency and Bankruptcy</a></h3>
                                       </div>
                                    </div>
                                    <div class="pbmit-service-content">
                                       <div class="at-above-post-homepage addthis_tool"></div>
                           ...
                           <div class="serviceBox pbminfotech-post-item d-flex justify-content-between">
                              <div class="innerBox d-flex justify-content-between align-items-center">
                                 <div class="pbminfotech-post-item-inner">
                                    <div class="pbminfotech-box-content">
                                       <div class="pbminfotech-box-content-inner">
                                          <h3 class="pbmit-service-title"><a href="">Real Estate</a></h3>
                                       </div>
                                    </div>
                                    <div class="pbmit-service-content">
                                       <div class="at-above-post-homepage addthis_tool"></div>
                                 ...
                                 <div class="pbmit-service-icon">
                                    <img src="images/services/service5.png" alt="">	
                                 </div>
                              </div>
                           </div>
                        </article>
                           ...
                           <div class="serviceBox pbminfotech-post-item d-flex justify-content-between">
                              <div class="innerBox d-flex justify-content-between align-items-center">
                                 <div class="pbminfotech-post-item-inner">
                                    <div class="pbminfotech-box-content">
                                       <div class="pbminfotech-box-content-inner">
                                          <h3 class="pbmit-service-title"><a href="">Projects | Infrastructure | Government Advisory Services</a></h3>
                                       </div>
                                    </div>
                                    <div class="pbmit-service-content">
                                       <div class="at-above-post-homepage addthis_tool"></div>
                                 ...
                                 <div class="pbmit-service-icon">
                                    <img src="images/services/service6.png" alt="">	
                                 </div>
                              </div>
                           </div>
                        </article>
                           ...
                           <div class="serviceBox pbminfotech-post-item d-flex justify-content-between">
                              <div class="innerBox d-flex justify-content-between align-items-center">
                                 <div class="pbminfotech-post-item-inner">
                                    <div class="pbminfotech-box-content">
                                       <div class="pbminfotech-box-content-inner">
                                          <h3 class="pbmit-service-title"><a href="">Succession | Estate Planning</a></h3>
                                       </div>
                                    </div>
                                    <div class="pbmit-service-content">
                                       <div class="at-above-post-homepage addthis_tool"></div>
                                 ...
                                 <div class="pbmit-service-icon">
                                    <img src="images/services/service7.png" alt="">	
                                 </div>
                              </div>
                           </div>
                        </article>
            ...
            <!-- <section class="experience-section-home1 section-lgb">
               <div class="container">
                  <div class="pbmit-heading  text-center animation-style2">
                     <h2 class="pbmit-title">A Passion For Justice. The<br>
                        Experience For Win.</h2>
                  </div>
               </div>
                     ...
                     <ol>
                           ...
                           <div class="pbmit-content">
                              <div class="pbmit-content-inner">
                                 <div class="pbmit-hover-img">
                                    <img src="images/history/history01.jpg" alt="Our new branch">											
                                 </div>
                                 <div class="time">June 2015</div>
                                 <p class="simple-text"> sed do eiusmod tempor labore<br>dolore magna aliqua.</p>
                              </div>
                           </div>
                        </li>
                        <li>
                           <div class="pbmit-content">
                              <div class="pbmit-content-inner">
                                 <div class="pbmit-hover-img">
                                    <img src="images/history/history02.jpg" alt="Our new branch">											
                                 </div>
                                 <div class="time">June 2017</div>
                                 <p class="simple-text"> sed do eiusmod tempor labore<br>dolore magna aliqua.</p>
                              </div>
                           </div>
                        </li>
                        <li>
                           <div class="pbmit-content">
                              <div class="pbmit-content-inner">
                                 <div class="pbmit-hover-img">
                                    <img src="images/history/history03.jpg" alt="Our new branch">											
                                 </div>
                                 <div class="time">June 2019</div>
                                 <p class="simple-text"> sed do eiusmod tempor labore<br>dolore magna aliqua.</p>
                              </div>
                           </div>
                        </li>
                        <li>
                           <div class="pbmit-content">
                              <div class="pbmit-content-inner">
                                 <div class="pbmit-hover-img">
                                    <img src="images/history/history05.jpg" alt="Our new branch">											
                                 </div>
                                 <div class="time">Aug 2020</div>
                                 <p class="simple-text"> sed do eiusmod tempor labore<br>dolore magna aliqua.</p>
                              </div>
                           </div>
                        </li>
                        <li>
                           <div class="pbmit-content">
                              <div class="pbmit-content-inner">
                                 <div class="pbmit-hover-img">
                                    <img src="images/history/history07.jpg" alt="Our new branch">											
                                 </div>
                                 <div class="time">Sep 2021</div>
                                 <p class="simple-text"> sed do eiusmod tempor labore<br>dolore magna aliqua.</p>
                              </div>
                           </div>
                        </li>
                        <li>
                           <div class="pbmit-content">
                              <div class="pbmit-content-inner">
                                 <div class="pbmit-hover-img">
                                    <img src="images/history/history06.jpg" alt="Our new branch">											
                                 </div>
                                 <div class="time">Dec 2022</div>
                                 <p class="simple-text"> sed do eiusmod tempor labore<br>dolore magna aliqua.</p>
                              </div>
                           </div>
                        </li>
                        <li>
                           <div class="pbmit-content">
                              <div class="pbmit-content-inner">
                                 <div class="pbmit-hover-img">
                                    <img src="images/history/history04.jpg" alt="Our new branch">											
                                 </div>
                                 <div class="time">Dec 2022</div>
                                 <p class="simple-text"> sed do eiusmod tempor labore<br>dolore magna aliqua.</p>
                              </div>
            ...
            <!-- <div class="countSec" style="background: url(images/count/count-bg.jpg) no-repeat center center;">
               <div class="container">
                  <div class="row"></div>
               </div>
            </div> -->
                           ...
                           <div class="pbmit-bg-imgbox">
                              <div class="pbmit-img">
                                 <div class="pbmit-split-slide-item-image">
                                    <img src="images/slide-new-001.jpg" alt="Satisfied Client">
                                 </div>
                                 <div class="pbmit-split-slide-item-image">
                                    <img src="images/slide-new-02.jpg" alt="Successful Cases">
                                 </div>
                                 <div class="pbmit-split-slide-item-image">
                                    <img src="images/slide-new-03.jpg" alt="Professional Attorneys">
                                 </div>
                                 ...
                                 <div class="pbmit-split-slide-box">
                                    <div class="pbmit-split-responsive-image">  
                                       ...
                                       <div class="pbmit-icon-box-wrapper d-flex align-items-center">
                                          <div class="pbmit-ihbox-icon">
                                             <div class="pbmit-icon-wrapper pbmit-icon-type-icon">
                                                <i class="pbmit-attorly-icon pbmit-attorly-icon-customer-service"></i>
                                             </div>
                                          </div>
                                       ...
                                       <div class="pbmit-split-slide-desc">Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium, totam rem aperiam, eaque ipsa quae ab illo inventore </div>
                                    </div>
                                 </div>
                              </div>
                              <div class="pbmit-split-slide-wrapper">
                                 <div class="pbmit-split-slide-box">
                                    <div class="pbmit-split-responsive-image">
                                       ...
                                       <div class="pbmit-icon-box-wrapper d-flex align-items-center">
                                          <div class="pbmit-ihbox-icon">
                                             <div class="pbmit-icon-wrapper pbmit-icon-type-icon">
                                                <i class="pbmit-attorly-icon pbmit-attorly-icon-justice-scale-1"></i>
                                             </div>
                                          </div>
                                          <div class="pbmit-split-slide-number">
                                             <h4>500+</h4>
                              ...
                              <div class="pbmit-split-slide-wrapper">
                                 <div class="pbmit-split-slide-box">
                                    <div class="pbmit-split-responsive-image">
                                       ...
                                       <div class="pbmit-split-slide-title">
                                          <h4>Matters and Assignments Handled</h4>
                                       </div>
                                       <div class="pbmit-split-slide-desc">Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium, totam rem aperiam, eaque ipsa quae ab illo inventore</div>
                                    </div>
                                 </div>
                                    ...
                                    <div class="pbminfotech-team-image-box">
                                       ...
                                       <div class="pbmit-featured-img-wrapper">
                                          <div class="pbmit-featured-wrapper">
                                             <img src="images/team/team-01.png" class="img-fluid" alt="">
                                          </div>
                                       </div>
                                    </div>
                                    <div class="pbminfotech-box-content">
                                       <div class="pbminfotech-box-content-inner">
                                          <h3 class="pbmit-team-title">
                                             <a href="#">Ajay Agarwal</a></h3>
                                          <div class="pbminfotech-team-position">
                                             <div class="pbminfotech-box-team-position">Partner</div>
                                          </div>
                                       </div>
                                    </div>
                                 </div>
                              ...
                              <article class="pbmit-team-style-2">
                                 <div class="pbminfotech-post-item">
                                    <div class="pbminfotech-team-image-box">
                                       ...
                                       <div class="pbmit-featured-img-wrapper">
                                          <div class="pbmit-featured-wrapper">
                                             <img src="images/team/team-02.png" class="img-fluid" alt="">
                                          </div>
                                       </div>
                                    </div>
                                    <div class="pbminfotech-box-content">
                              ...
                              <article class="pbmit-team-style-2">
                                 <div class="pbminfotech-post-item">
                                    <div class="pbminfotech-team-image-box">
                                       ...
                                       <div class="pbmit-featured-img-wrapper">
                                          <div class="pbmit-featured-wrapper">
                                             <img src="images/team/team-03.png" class="img-fluid" alt="">
                                          </div>
                                       </div>
                                    </div>
                                    <div class="pbminfotech-box-content">
                                       <div class="pbminfotech-box-content-inner">
                                          <h3 class="pbmit-team-title">
                                             <a href="#">Aparna Banerjee Dasgupta</a></h3>
                                          <div class="pbminfotech-team-position">
                                             <div class="pbminfotech-box-team-position">Partner</div>
                                          </div>
                                       </div>
                              ...
                              <article class="pbmit-team-style-2">
                                 <div class="pbminfotech-post-item">
                                    <div class="pbminfotech-team-image-box">
                                       ...
                                       <div class="pbmit-featured-img-wrapper">
                                          <div class="pbmit-featured-wrapper">
                                             <img src="images/team/team-04.png" class="img-fluid" alt="">
                                          </div>
                                       </div>
                                    </div>
                                    <div class="pbminfotech-box-content">
                                       <div class="pbminfotech-box-content-inner">
                                          <h3 class="pbmit-team-title">
                                             <a href="#">Arun Kumar Mandal</a></h3>
                                          <div class="pbminfotech-team-position">
                                             <div class="pbminfotech-box-team-position">Senior Partner</div>
                                          </div>
                                       </div>
                                    </div>
                                 </div>
                              ...
                              <article class="pbmit-team-style-2">
                                 <div class="pbminfotech-post-item">
                                    <div class="pbminfotech-team-image-box">
                                       ...
                                       <div class="pbmit-featured-img-wrapper">
                                          <div class="pbmit-featured-wrapper">
                                             <img src="images/team/team-05.png" class="img-fluid" alt="">
                                          </div>
                                       </div>
                                    </div>
                                    <div class="pbminfotech-box-content">
                                       <div class="pbminfotech-box-content-inner">
                                          <h3 class="pbmit-team-title">
                                             <a href="#">Catalina Sage</a></h3>
                                          <div class="pbminfotech-team-position">
                                             <div class="pbminfotech-box-team-position">Criminal Lawyer</div>
                                          </div>
                                       </div>
                                    </div>
                                 </div>
                           ...
                           <article class="pbmit-blog-style-1">
                              <div class="post-item">
                                 <div class="pbmit-featured-container">
                                    <div class="pbmit-featured-img-wrapper">
                                       <div class="pbmit-featured-wrapper">
                                          <img src="images/blog/blog-5.jpg" class="img-fluid" alt="">
                                       </div>
                                    </div>
                                 </div>
                                 <div class="pbminfotech-box-content">
                                    ...
                                    <div class="pbmit-box-content-wrapper">
                                       ...
                                       <div class="pbminfotech-box-desc-text">
                                          Performance marketing may involve using various types of digital marketing…			
                                       </div>
                                    </div>
                                 </div>
                              </div>
                           ...
                           <article class="pbmit-blog-style-1">
                              <div class="post-item">
                                 <div class="pbmit-featured-container">
                                    <div class="pbmit-featured-img-wrapper">
                                       <div class="pbmit-featured-wrapper">
                                          <img src="images/blog/blog-4.jpg" class="img-fluid" alt="">
                                       </div>
                                    </div>
                                 </div>
                                 <div class="pbminfotech-box-content">
            ...
            <!-- Portfolio Start -->
            <!-- <section class="portfolio-section-home4  pbmit-element-portfolio-style-2">
               <div class="container">
                  <div class="row">
                     <div class="pbmit-heading text-left animation-style2">
                        <h2 class="pbmit-title">Our Case Study</h2>
                  ...
                  <div class="row" data-cursor-text="View">
                     <div class="col-md-6">
                        <article class="pbmit-portfolio-style-2 business pbmit-odd ">
                           <div class="pbminfotech-post-content">
                              <div class="pbmit-image-wrapper">
                                 <div class="pbmit-featured-img-wrapper">
                                    <div class="pbmit-featured-wrapper">
                                       <img src="images/case-study/case1.jpg" class="img-fuild" alt="">
                                    </div>
                                    <div class="logoImg">
                                       <img src="images/client/client-white-01.png" alt="">
                                    </div>
                                 </div>
                              </div>
                              <div class="pbminfotech-box-content">
                                 <div class="pbminfotech-titlebox">
                                    <h3 class="pbmit-portfolio-title">
                                       <a href="#">Corporate Fraud and Accountability</a></h3>
                                    <div class="pbmit-port-cat">
                                       <a href="#" rel="tag">Case Study 1</a>
                                    </div>
                                 </div>
                              </div>
                              <a class="pbmit-link" title="Medical Negligence" href="#"></a>
                           </div>
                        </article>
                     </div>
                     <div class="col-md-6">
                        <article class="pbmit-portfolio-style-2 financial pbmit-even">
                           <div class="pbminfotech-post-content">
                              <div class="pbmit-image-wrapper">
                                 <div class="pbmit-featured-img-wrapper">
                                    <div class="pbmit-featured-wrapper">
                                       <img src="images/case-study/case2.jpg" class="img-fuild" alt="">
                                    </div>
                                    <div class="logoImg">
                                       <img src="images/client/client-white-01.png" alt="">
                                    </div>
                              ...
                              <div class="pbminfotech-box-content">
                                 <div class="pbminfotech-titlebox">
                                    <h3 class="pbmit-portfolio-title">
                                       <a href="#">Emissions Scandal and Corporate Liability</a></h3>
                                    <div class="pbmit-port-cat">
                                       <a href="#" rel="tag">Case Study 2</a>
                                    </div>
                                 </div>
                              </div>
                              <a class="pbmit-link" title="Tax Consultancy" href="#"></a>
                           </div>
                        </article>
                     </div>
                     <div class="col-md-6">
                        <article class="pbmit-portfolio-style-2 pbmit-odd ">
                           <div class="pbminfotech-post-content">
                              <div class="pbmit-image-wrapper">
                                 <div class="pbmit-featured-img-wrapper">
                                    <div class="pbmit-featured-wrapper">
                                       <img src="images/case-study/case3.jpg" class="img-fuild" alt="">
                                    </div>
                                    <div class="logoImg">
                                       <img src="images/client/client-white-01.png" alt="">
                                    </div>
                              ...
                              <div class="pbminfotech-box-content">
                                 <div class="pbminfotech-titlebox">
                                    <h3 class="pbmit-portfolio-title">
                                       <a href="#">Corporation and Shareholder Rights</a></h3>
                                    <div class="pbmit-port-cat">
                                       <a href="#" rel="tag">Case Study 3</a>
                                    </div>
                                 </div>
                              </div>
                              <a class="pbmit-link" title="Trade and Markets" href="#"></a>
                           </div>
                        </article>
                     </div>
                     <div class="col-md-6">
                        <article class="pbmit-portfolio-style-2 personal pbmit-even">
                           <div class="pbminfotech-post-content">
                              <div class="pbmit-image-wrapper">
                                 <div class="pbmit-featured-img-wrapper">
                                    <div class="pbmit-featured-wrapper">
                                       <img src="images/case-study/case4.jpg" class="img-fuild" alt="">
                                    </div>
                                    <div class="logoImg">
                                       <img src="images/client/client-white-01.png" alt="">
                                    </div>
                              ...
                              <div class="pbminfotech-box-content">
                                 <div class="pbminfotech-titlebox">
                                    <h3 class="pbmit-portfolio-title">
                                       <a href="#">Dominance in Online Retail</a></h3>
                                    <div class="pbmit-port-cat">
                                       <a href="#" rel="tag">Case Study 4</a>
                                    </div>
                                 </div>
                              </div>
                              <a class="pbmit-link" title="Marriage Agreements" href="#"></a>
                           </div>
                        </article>
                     </div>
                  </div>
